...
> [!CAUTION] Written for Legacy Version
>
> This page is not actively maintained -- it was originally written for the Electron version which isn't currently being updated.
...
My preferred chat model has been Meta's Llama 3, [quantized by bartowski](https://huggingface.co/bartowski/Meta-Llama-3-8B-Instruct-GGUF). You can find links to download quanized/smaller versions of the model below.

(The higher the number e.g. Q8, the better the model, but the more VRAM it will require.)

| Model | File Size | Est. VRAM Usage |  |
| --- | --- | --- | --- |
| Q2_K | 3.17GB | 4.5GB | [Download](https://huggingface.co/bartowski/Meta-Llama-3-8B-Instruct-GGUF/blob/main/Meta-Llama-3-8B-Instruct-Q2_K.gguf) |
| Q4_K_M | 4.92GB | 5.9GB | [Download](https://huggingface.co/bartowski/Meta-Llama-3-8B-Instruct-GGUF/blob/main/Meta-Llama-3-8B-Instruct-Q4_K_M.gguf) |
| Q8_0 | 8.54GB | 9.1GB | [Download](https://huggingface.co/bartowski/Meta-Llama-3-8B-Instruct-GGUF/blob/main/Meta-Llama-3-8B-Instruct-Q8_0.gguf) |

## Image Model (Required)

I've been using [Toonify SD 1.5](https://civitai.com/models/36281?modelVersionId=244831).

| Model | File Size | Est. VRAM Usage |  |
| --- | --- | --- | --- |
| Toonify SD 1.5 | 1.98GB | 3GB | [Download](https://civitai.com/api/download/models/244831) |
