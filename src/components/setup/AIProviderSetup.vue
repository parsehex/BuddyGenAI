...
<template>
  <div class="max-w-4xl mx-auto p-4">
    <p class="text-center text-lg mb-6">
      To use BuddyGenAI, you have to connect the app to an AI provider.
    </p>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <!-- Cloud AI Card -->
      <Card
        class="cursor-pointer transition-all duration-200 hover:shadow-lg bg-card"
        :class="{
      ...
      >
        <CardHeader class="flex items-center justify-center bg-card rounded">
          <h3 class="text-xl font-semibold">Cloud AI</h3>
        </CardHeader>
        <CardContent class="text-muted-foreground flex flex-col items-center gap-2 bg-card rounded">
          <div class="flex items-center">
            powered by
            <div class="bg-white dark:bg-gray-700 rounded-lg p-1 mx-2">
      ...
      >
        <CardHeader class="flex items-center justify-center relative">
          <h3 class="text-xl font-semibold">On-Device AI</h3>
        </CardHeader>
        <CardContent class="text-muted-foreground flex flex-col items-center gap-2 relative">

          <div class="flex items-center">
            powered by
            <img src="/assets/kobolddiscordgear.png" class="w-12 h-12 opacity-70 mx-2" alt="KoboldCpp" />
            KoboldCpp
          </div>
